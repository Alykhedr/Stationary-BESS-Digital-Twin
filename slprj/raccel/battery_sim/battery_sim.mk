...
MODEL                   = battery_sim
MODULES                 = battery_sim.c battery_sim_capi.c battery_sim_data.c battery_sim_tgtconn.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = battery_sim.exe
MAKEFILE                = battery_sim.mk
MATLAB_ROOT             = C:\Program Files\MATLAB\R2024a
ALT_MATLAB_ROOT         = C:\PROGRA~1\MATLAB\R2024a
START_DIR               = C:\Users\ALIKHE~1\Desktop\Uni\NEWTHE~1\THESIS~3
S_FUNCTIONS_LIB         = 
NUMST                   = 4
NCSTATES                = 0
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = battery_sim_ref.rsp
COMPILER_COMMAND_FILE     = battery_sim_comp.rsp
